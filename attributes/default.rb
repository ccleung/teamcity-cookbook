...
default["teamcity_server"]["ebs_mount"]                         = "/opt/TeamCity"
default["teamcity_server"]["root_dir"]                          = "#{node['teamcity_server']['ebs_mount']}/teamcity_server"
default["teamcity_server"]["logs_dir"]                          = node["teamcity_server"]["root_dir"]+'/logs'
default["teamcity_server"]["data_dir"]                          = "#{node['teamcity_server']['ebs_mount']}/.BuildServer"
